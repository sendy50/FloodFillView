package com.sendy.FloodFillView;

/**
 * Created by lakmal on animal2/29/16.
 */
...
public class FloodFillView extends ImageView {
    ...
    public FloodFillView(Context context) {
        super(context);
        sharedConstructing(context);
    }

    public FloodFillView(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructing(context);
    }

    public FloodFillView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        sharedConstructing(context);
    }

    public void AllClear(Bitmap bitmap){
        constructor(bitmap);
    }

    public void FloodFill(Bitmap bitmap,int currentX,int currentY,int mSelectedColor,int TargetColor,int Tolerance){
        floodFill(bitmap, currentX, currentY, mSelectedColor, TargetColor, Tolerance);
    }

    public void Redu(Bitmap bitmap, int fillColor,int targetColor,int tolerance){
        redo(bitmap, fillColor, targetColor, tolerance);
    }
    ...
    public void setZoom(FloodFillView img) {
