...
extern "C" {
JNIEXPORT void JNICALL Java_com_sendy_FloodFillView_FloodFillView_constructor(JNIEnv *env);

JNIEXPORT void JNICALL Java_com_sendy_FloodFillView_FloodFillView_redo(JNIEnv *env,
                                                                                   jobject obj,
                                                                                   jobject bitmap,
                                                                                   uint32_t fillColor,
...
JNIEXPORT void JNICALL Java_com_sendy_FloodFillView_FloodFillView_floodFill(JNIEnv *env,
                                                                                        jobject obj,
                                                                                        jobject bitmap,
                                                                                        uint32_t x,
                                                                                        uint32_t y,
